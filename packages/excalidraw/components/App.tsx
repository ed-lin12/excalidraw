...
class App extends React.Component<AppProps, AppState> {
  ...
  private onAddCatClick = async () => {
    ...
    // Embedded artwork keeps one-click insertion available offline.
    const cat = `<svg xmlns="http://www.w3.org/2000/svg" width="240" height="240" viewBox="0 0 240 240">
    ...
    await this.insertImages([SVGStringToFile(cat, "cat.svg")], x, y);
  };
